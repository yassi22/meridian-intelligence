...
🔗 Live: meridianintel.nl · 🌐 Portfolio: yassinc.nl
...
A note on the code
This repository is a case study. Meridian's source code is intentionally private because the platform includes security-sensitive capabilities. I'm happy to walk through the architecture and technical decisions in detail — reach out via yassinc.nl.
